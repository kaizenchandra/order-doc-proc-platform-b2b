...
public class WorkflowConfiguration {
    ...
    DocumentStorage documentStorage() {
        return new DocumentStorage() {
            ...
            public VerifiedUpload inspect(String bucket, String objectName) {
                throw unavailable();
            }

            private ApiFailure unavailable() {
                return new ApiFailure(503, "Document storage is not configured");
            }
        };
    }
}
