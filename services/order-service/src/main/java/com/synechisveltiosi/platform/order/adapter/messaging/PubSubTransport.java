...
public class PubSubTransport implements EventPublisher, AutoCloseable {
    ...
    private Publisher publisher(String topic) throws Exception {
        ...
        if (emulatorProvider != null)
            builder.setChannelProvider(emulatorProvider).setCredentialsProvider(NoCredentialsProvider.create());
    ...
    @Override
    public void publish(String destination, byte[] bytes, Map<String, String> attributes) throws Exception {
