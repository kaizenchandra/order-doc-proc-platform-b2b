...
# images = {
#   document = "asia-south1-docker.pkg.dev/PROJECT/orders-prod/document-service@sha256:DIGEST"
#   notification = "asia-south1-docker.pkg.dev/PROJECT/orders-prod/notification-service@sha256:DIGEST"
# }
