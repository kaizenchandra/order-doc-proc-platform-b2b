...
project_id = "replace-staging-project"
region     = "asia-south1"
# Stage 1 creates only the foundation. Populate images and secrets before Stage 2.
enable_cloud_run  = false
database_prepared = false
# images = {
#   document = "asia-south1-docker.pkg.dev/PROJECT/orders-staging/document-service@sha256:DIGEST"
#   notification = "asia-south1-docker.pkg.dev/PROJECT/orders-staging/notification-service@sha256:DIGEST"
# }
