...
class EventsTest {
    @Test void resultRequiresExactlyOneValidOutcome() {
        var doc = UUID.randomUUID(); var request = UUID.randomUUID();
    ...
    @Test void envelopeRejectsWrongSourceVersionAndOutcomeType() {
    ...
    @Test void generationMustBePositiveCanonicalAndFitSignedLong() {
